...
class HousingDetailActivity :BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Housing").child(itemId)
        ...
        databaseReference.get().addOnSuccessListener { dataSnapshot ->
            ...
            updateUI(item, titleView, priceView, descriptionView, categoryView, fabLike)
                ...
                FirebaseDatabase.getInstance().getReference("user").child(sellerId)
                    .get().addOnSuccessListener { dataSnapshot ->
                        ...
                        if (seller != null) {
                            ...
                            val intent = Intent(this@HousingDetailActivity, ContactSellerActivity::class.java).apply {
                            ...
                            Toast.makeText(this@HousingDetailActivity, "Seller details not found.", Toast.LENGTH_SHORT).show()
                        }
                    }.addOnFailureListener {
                        Log.d("ItemDetailActivity", "Failed to fetch seller details: ${it.message}")
                        Toast.makeText(this@HousingDetailActivity, "Failed to load seller details.", Toast.LENGTH_SHORT).show()
                    }
            } else {
                Toast.makeText(this@HousingDetailActivity, "Seller ID is missing.", Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun updateUI(item: Item, titleView: TextView, priceView: TextView,
                         descriptionView: TextView, categoryView: TextView,
    ...
    private fun updateItemInDatabase() {
        ...
        FirebaseDatabase.getInstance().getReference("Housing").child(itemId).setValue(item)
    }
