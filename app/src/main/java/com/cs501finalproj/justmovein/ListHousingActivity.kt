...
class ListHousingActivity : AppCompatActivity() {
    ...
    private fun uploadImagesAndListNewItem() {
        ...
        if (validateInputs(title, description, category, price)) {
            uploadImages { imageUrls ->
                listNewItem(title, description, category, price!!, imageUrls)
            }
        } else {
    ...
    private fun listNewItem(title: String, description: String, category: String, price: Double, imageUrls: List<String>) {
        val item = Housing(
            title = title,
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("Housing").push()
    ...
    private fun validateInputs(title: String, description: String, category: String, price: Double?): Boolean {
        return title.isNotEmpty() && description.isNotEmpty() && category.isNotEmpty() && price != null
    }
}
